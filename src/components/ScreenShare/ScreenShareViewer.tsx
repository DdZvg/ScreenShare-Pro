...
+import React, { useRef, useEffect, useState } from 'react';
+import { Monitor, Users, Maximize2, Phone, Volume2, VolumeX, MessageCircle, Mic, MicOff } from 'lucide-react';
...
+export const ScreenShareViewer: React.FC<ScreenShareViewerProps> = ({ room, user, onLeaveRoom }) => {
